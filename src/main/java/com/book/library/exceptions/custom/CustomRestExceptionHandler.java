package com.book.library.exceptions.custom; //package com.alaajo.projectalaajo.client.exception;

import com.fasterxml.jackson.databind.exc.UnrecognizedPropertyException;
import com.book.library.exceptions.response.ApiError;
...
public class CustomRestExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  @ExceptionHandler(DonationReferenceExistsException.class)
  ResponseEntity<?> handleDonationRefereneExists(DonationReferenceExistsException ex) {
